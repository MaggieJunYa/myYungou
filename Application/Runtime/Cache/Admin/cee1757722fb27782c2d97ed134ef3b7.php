...
<head>
    ...
    <!--引入富文本编辑器的3个js文件-->
    <script type="text/javascript" charset="utf-8" src="<?php echo C('AD_JS');?>/Ueditor/ueditor.config.js"></script>
    <script type="text/javascript" charset="utf-8" src="<?php echo C('AD_JS');?>/Ueditor/ueditor.all.min.js"> </script>
    <script type="text/javascript" charset="utf-8" src="<?php echo C('AD_JS');?>/Ueditor/lang/zh-cn/zh-cn.js"></script>
