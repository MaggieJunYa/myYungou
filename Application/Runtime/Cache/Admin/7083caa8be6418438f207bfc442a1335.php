...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
            ...
            <?php if(is_array($info["Roleinfo"])): foreach($info["Roleinfo"] as $key=>$v): ?><tr>
                    ...
                    <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
                        ...
                        <img src="<?php echo C('AD_IMG_URL');?>del.gif" width="10" height="10" /> <a href="<?php echo U('delete',array('role_id'=>$v['role_id']));?>" style="color:rgb(59,99,117)">删除</a> | 查看 | <a href="<?php echo U('distribute',array('role_id'=>$v['role_id']));?>" style="color:rgb(59,99,117)"><img src="<?php echo C('AD_IMG_URL');?>edit.gif" width="10" height="10" /> 编辑</a></div></td>
