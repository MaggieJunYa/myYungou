        ...
        <td>
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" id="general-tab-show">
                    <tr>
                        <td height="20" bgcolor="#FFFFFF" class="STYLE6" colspan="2"><div align="left">当前正在给<span style="font-size: 25px;color:blue;">【<?php echo ($roleinfo["role_name"]); ?>】</span>角色分配权限</div></td>
                        </div></td>
                    </tr>
                    <?php if(is_array($authinfoA)): foreach($authinfoA as $key=>$v): ?><tr>
                        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="right"><span class="STYLE19"><input
                                type="checkbox" name="auth_id[]" value="<?php echo ($v["auth_id"]); ?>" <?php if(in_array(($v["auth_id"]), is_array($roleinfo["role_auth_ids"])?$roleinfo["role_auth_ids"]:explode(',',$roleinfo["role_auth_ids"]))): ?>checked='checked'<?php endif; ?>><?php echo ($v["auth_name"]); ?></span></div></td>
                    ...
                    <tr>
                        <td height="20" bgcolor="#FFFFFF" class="STYLE6" colspan="2"><div align="center"><span style="font-size: 25px;color:blue;"><input
                                type="submit" value="分配权限"></span></div></td>
                        </div></td>
                    </tr>
                </table>
            </form>
