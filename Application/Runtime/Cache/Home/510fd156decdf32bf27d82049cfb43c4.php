                ...
                <div class="fr pc-login-box">
                    ...
                    <form action="" method="post">
                        <div class="pc-sign">
                            ...
                            <span style="color:#f00;"><?php echo ((isset($error["username"]) && ($error["username"] !== ""))?($error["username"]): ''); ?></span>
                        </div>
                        <div class="pc-sign">
                            <input type="password" placeholder="请输入密码" name="password" id="password">
                            <span style="color:#f00;"><?php echo ((isset($error["password"]) && ($error["password"] !== ""))?($error["password"]): ''); ?></span>
                        </div>
                        <div class="pc-sign">
                            <input type="password" placeholder="请确认密码" name="password2" id="password2">
                            <span style="color:#f00;"><?php echo ((isset($error["password2"]) && ($error["password2"] !== ""))?($error["password2"]): ''); ?></span>
                        </div>
                        <!--<div class="pc-sign">-->
                            <!--<input type="password" placeholder="请输入验证码" name="verifyCode">-->
                        <!--</div>-->
                        ...
                        <div class="pc-reg">
                            <a href="<?php echo U('login');?>" class="red">已有账号 请登录</a>
                        </div>
                    </form>
                </div>
            </div>
