        ...
        <div class="containers">
                ...
                <div class="pc-nav-digit clearfix">
                    <ul>
                        <?php if(is_array($goodsInfo)): foreach($goodsInfo as $key=>$v): ?><li>
                            <div class="digit1"><a href="<?php echo U('detail',array('goods_id'=>$v['goods_id']));?>"><img src="<?php echo ($v["goods_small_logo"]); ?>" width="100%"></a></div>
                            <div class="digit2"><a href="<?php echo U('detail',array('goods_id'=>$v['goods_id']));?>"><?php echo ($v["goods_name"]); ?></a></div>
                            <div class="digit3"><a href="<?php echo U('detail',array('goods_id'=>$v['goods_id']));?>" style="color:#f00;font-size:15px;">￥<?php echo ($v["goods_price"]); ?></a></div>
            ...
            <div>
                ...
                <div class="pc-nav-digit clearfix">
                    <ul>
                        <li>
                            <div class="digit1"><a href="#"><img src="<?php echo C('HO_IMG');?>shangpinxiangqing/X-1.png" width="100%"></a></div>
