    ...
    <ul class="Xcontent01">
        ...
        <ol class="Xcontent13 clearfix">
            <div class="Xcontent14 clearfix">
                <a href="#"><p><?php echo ($goodsInfo["goods_name"]); ?></p></a>
            </div>
            ...
            <div class="Xcontent17">
                ...
                <p class="Xcontent19">￥<span><?php echo ($goodsInfo["goods_price"]); ?></span></p>
            ...
            <?php if(is_array($manyinfo)): foreach($manyinfo as $key=>$v): ?><li class="product">
                    <dl>
                        ...
                        <dd>
                            <?php if(is_array($v["attr_vals"])): foreach($v["attr_vals"] as $k=>$vv): if(($k) == "0"): ?><a class="selected" href="javascript:;"><?php echo ($vv); ?> <input type="radio" name="color" value="<?php echo ($vv); ?>" checked="checked" /></a>
                                    <?php else: ?>
