...
<head>
    ...
    <script type="text/javascript" src="<?php echo C('HO_JS');?>jquery.js"></script>
    <script type="text/javascript" src="<?php echo C('HO_JS');?>index.js"></script>
    <script type="text/javascript" src="<?php echo C('HO_JS');?>modernizr-custom-v2.7.1.min.js"></script>
    <script type="text/javascript" src="<?php echo C('HO_JS');?>jquery.SuperSlide.js"></script>
...
<header id="pc-header">
    <div class="pc-header-nav">
        <div class="pc-header-con">
            <?php if(!empty($_SESSION['username'])): ?><div class="fl pc-header-link" >您好！<?php echo (session('username')); ?>
                <a href="<?php echo U('Member/logout');?>" onclick="return confirm('是否退出登录？')">退出登录</a></div>
                <?php else: ?>
                <div class="fl pc-header-link" >您好！，欢迎来云购物
                    <a href="<?php echo U('Home/Member/login');?>" target="_blank">请登录</a>
...
<div class="yBanner">
    <div class="yBannerList">
        <div class="yBannerListIn">
            <a href=""><img class="ymainBanner" src="<?php echo C('HO_IMG');?>banner1.jpg"  width="100%"></a>
            <div class="yBannerListInRight">
                <a href=""><img src="<?php echo C('HO_IMG');?>BR2.png" width="100%"/></a>
                <a href=""><img src="<?php echo C('HO_IMG');?>BR3.png" width="100%" /></a>
            </div>
        </div>
    </div>
    ...
    <div class="yBannerList ybannerHide">
        <div class="yBannerListIn">
            <a href=""><img class="ymainBanner" src="<?php echo C('HO_IMG');?>banner1.jpg" width="100%"></a>
            <div class="yBannerListInRight">
                <a href=""><img src="<?php echo C('HO_IMG');?>BR6.png" width="100%"/></a>
                <a href=""><img src="<?php echo C('HO_IMG');?>BR4.png" width="100%" /></a>
            </div>
        </div>
    </div>
    ...
    <div class="yBannerList ybannerHide">
        <div class="yBannerListIn">
            <a href=""><img class="ymainBanner" src="<?php echo C('HO_IMG');?>banner1.jpg" width="100%"></a>
            <div class="yBannerListInRight">
                <a href=""><img src="<?php echo C('HO_IMG');?>BR7.png" width="100%"/></a>
                <a href=""><img src="<?php echo C('HO_IMG');?>BR5.png" width="100%" /></a>
            </div>
        </div>
    </div>
</div>
...
<section id="">
    <div class="center pc-ad-img clearfix">
        <div class="pc-center-img"><img src="<?php echo C('HO_IM');?>ad/ad1.jpg"></div>
        <div class="pc-center-img"><img src="<?php echo C('HO_IM');?>ad/ad2.jpg"></div>
        <div class="pc-center-img"><img src="<?php echo C('HO_IM');?>ad/ad3.jpg"></div>
        <div class="pc-center-img"><img src="<?php echo C('HO_IM');?>ad/ad4.jpg"></div>
        <div class="pc-center-img"><img src="<?php echo C('HO_IM');?>ad/ad5.jpg"></div>
    </div>
</section>
<section id="s">
    <div class="center">
                                        ...
                                        <ul class="flder">
                                            <li index="0">
                                                <div class="xsq_deal_wrapper">
                                                    <a class="saleDeal" href="page.html" target="_blank">
                                                        <div class="dealCon">
                                                            <img class="dealImg" src="<?php echo C('HO_IMG');?>xlqg1.jpg" alt="">
                                                ...
                                                <div class="xsq_deal_wrapper">
                                                    <a class="saleDeal" href="" target="_blank">
                                                        <div class="dealCon">
                                                            <img class="dealImg" src="<?php echo C('HO_IMG');?>xlqg2.jpg" alt="">
                                                            <div class="zt2Qrcode overlay">
                                                                <div class="xsqMask"></div>
                                                                <p class="word1">15:00开抢</p>
                                                                <p class="word2">限100件，抢完恢复25.8元</p>
                                                ...
                                                <div class="xsq_deal_wrapper">
                                                    <a class="saleDeal" href="" target="_blank">
                                                        <div class="dealCon">
                                                            <img class="dealImg" src="<?php echo C('HO_IMG');?>xlqg3.jpg" alt="">
                                                ...
                                                <div class="xsq_deal_wrapper">
                                                    <a class="saleDeal" href="" target="_blank">
                                                        <div class="dealCon">
                                                            <img class="dealImg" src="<?php echo C('HO_IMG');?>xlqg4.jpg" alt="">
                                                            <div class="zt2Qrcode overlay">
                                                                <div class="xsqMask"></div>
                                                                <p class="word1">15:00开抢</p>
                                                                <p class="word2">限100件，抢完恢复25.8元</p>
                                                ...
                                                <div class="xsq_deal_wrapper">
                                                    <a class="saleDeal" href="" target="_blank">
                                                        <div class="dealCon">
                                                            <img class="dealImg" src="<?php echo C('HO_IMG');?>xlqg5.jpg" alt="">
                                                            <div class="zt2Qrcode overlay">
                                                                <div class="xsqMask"></div>
                                                                <p class="word1">15:00开抢</p>
                                                                <p class="word2">限100件，抢完恢复25.8元</p>
                                                ...
                                                <div class="xsq_deal_wrapper">
                                                    <a class="saleDeal" href="" target="_blank">
                                                        <div class="dealCon">
                                                            <img class="dealImg" src="<?php echo C('HO_IMG');?>xlqg6.jpg" alt="">
                                                            <div class="zt2Qrcode overlay">
                                                                <div class="xsqMask"></div>
                                                                <p class="word1">15:00开抢</p>
                                                                <p class="word2">限100件，抢完恢复25.8元</p>
                                            ...
                                            <li index="1">
                                                <div class="xsq_deal_wrapper">
                                                    <a class="saleDeal" href="" target="_blank">
                                                        <div class="dealCon">
                                                            <img class="dealImg" src="<?php echo C('HO_IMG');?>xlqg7.jpg" alt="">
                                                            <div class="zt2Qrcode overlay">
                                                                <div class="xsqMask"></div>
                                                                <p class="word1">15:00开抢</p>
                                                                <p class="word2">限100件，抢完恢复25.8元</p>
                                                ...
                                                <div class="xsq_deal_wrapper">
                                                    <a class="saleDeal" href="" target="_blank">
                                                        <div class="dealCon">
                                                            <img class="dealImg" src="<?php echo C('HO_IMG');?>xlqg8.jpg" alt="">
                                                            <div class="zt2Qrcode overlay">
                                                                <div class="xsqMask"></div>
                                                                <p class="word1">15:00开抢</p>
                                                                <p class="word2">限100件，抢完恢复25.8元</p>
                                                ...
                                                <div class="xsq_deal_wrapper">
                                                    <a class="saleDeal" href="" target="_blank">
                                                        <div class="dealCon">
                                                            <img class="dealImg" src="<?php echo C('HO_IMG');?>xlqg9.jpg" alt="">
                                                            <div class="finish overlay">
                                                                <div class="xsqMask"></div>
                                                                <p class="word1">15:00开抢</p>
                                                                <p class="word2">限100件，抢完恢复25.8元</p>
                                                ...
                                                <div class="xsq_deal_wrapper">
                                                    <a class="saleDeal" href="" target="_blank">
                                                        <div class="dealCon">
                                                            <img class="dealImg" src="<?php echo C('HO_IMG');?>xlqg10.jpg" alt="">
                                                            <div class="zt2Qrcode overlay">
                                                                <div class="xsqMask"></div>
                                                                <p class="word1">15:00开抢</p>
                                                                <p class="word2">限100件，抢完恢复25.8元</p>
                                                ...
                                                <div class="xsq_deal_wrapper">
                                                    <a class="saleDeal" href="" target="_blank">
                                                        <div class="dealCon">
                                                            <img class="dealImg" src="<?php echo C('HO_IMG');?>xlqg11.jpg" alt="">
                                                            <div class="zt2Qrcode overlay">
                                                                <div class="xsqMask"></div>
                                                                <p class="word1">15:00开抢</p>
                                                                <p class="word2">限100件，抢完恢复25.8元</p>
                                                ...
                                                <div class="xsq_deal_wrapper">
                                                    <a class="saleDeal" href="" target="_blank">
                                                        <div class="dealCon">
                                                            <img class="dealImg" src="<?php echo C('HO_IMG');?>xlqg12.jpg" alt="">
                                                            <div class="zt2Qrcode overlay">
                                                                <div class="xsqMask"></div>
                                                                <p class="word1">15:00开抢</p>
                                                                <p class="word2">限100件，抢完恢复25.8元</p>
        ...
        <div class="pc-center-he">
            ...
            <div class="pc-list-goods">
                <div class="xsq_deal_wrapper pc-deal-list clearfix">
                    <a class="saleDeal" href="" target="_blank">
                        <div class="dealCon"><img class="dealImg" src="<?php echo C('HO_IMG');?>xlqg13.jpg" alt=""></div>
                    ...
                    <a class="saleDeal" href="" target="_blank">
                        <div class="dealCon"><img class="dealImg" src="<?php echo C('HO_IMG');?>xlqg14.jpg" alt=""></div>
                    ...
                    <a class="saleDeal" href="" target="_blank">
                        <div class="dealCon"><img class="dealImg" src="<?php echo C('HO_IMG');?>xlqg15.jpg" alt=""></div>
                        <div class="title_new"><p class="word" title="【京东超市】福临门 葵花籽原香食用调和油5L 中粮出品"><span class="baoyouText">[包邮]</span>【京东超市】福临门 葵花籽原香食用调和油5L 中粮出品</p></div>
                        <div class="dealInfo"><span class="price">¥<em>99.9</em></span></div>
                    </a>
                    <a class="saleDeal" href="" target="_blank">
                        <div class="dealCon"><img class="dealImg" src="<?php echo C('HO_IMG');?>xlqg16.jpg" alt=""></div>
                    ...
                    <a class="saleDeal" href="" target="_blank">
                        <div class="dealCon"><img class="dealImg" src="<?php echo C('HO_IMG');?>xlqg17.jpg" alt=""></div>
                    ...
                    <a class="saleDeal" href="" target="_blank">
                        <div class="dealCon"><img class="dealImg" src="<?php echo C('HO_IMG');?>xlqg18.jpg" alt=""></div>
    ...
    <div class="center pc-top-20">
        <div class="pc-center-he">
            ...
            <div class="pc-list-goods" style="height:auto">
                <div class="xsq_deal_wrapper pc-deal-list clearfix">
                    <a class="saleDeal" href="" target="_blank">
                        <div class="dealCon"><img class="dealImg" src="<?php echo C('HO_IMG');?>xlqg19.jpg" alt=""></div>
                        <div class="title_new"><p class="word" title="【京东超市】福临门 葵花籽原香食用调和油5L 中粮出品"><span class="baoyouText">[包邮]</span>【京东超市】福临门 葵花籽原香食用调和油5L 中粮出品</p></div>
                        <div class="dealInfo"><span class="price">¥<em>39.9</em></span></div>
                    </a>
                    <a class="saleDeal" href="" target="_blank">
            ...
            <ul class="clearfix">
                ...
                <li class="lss">
                    ...
                    <div class="clearfix lss-pa">
                        <div class="fl lss-img"><img src="<?php echo C('HO_IM');?>icon/code.png" alt=""></div>
